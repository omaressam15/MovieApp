...
class TopRatingMoviesView extends StatelessWidget {
  const TopRatingMoviesView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesBloc,MoviesState>(
        ...
        builder: (context,stats){
          switch(stats.statesTopRatedMovies){
             ...
             return FadeIn(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: stats.topRatedMovies.length,
                    itemBuilder: (context, index) {
                      final movie = stats.topRatedMovies[index];
                      return Container(
            ...
            case RequestStates.error:
              return SizedBox(
                height: 170,
                child:Center(child: Text(stats.massageTopRated)) ,
              );
          }
        }
    );
